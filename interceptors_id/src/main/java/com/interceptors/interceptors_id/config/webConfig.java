...
import com.interceptors.interceptors_id.controllers.TimeInterceptor;
...
public class webConfig implements WebMvcConfigurer { // WebMvcConfigurer es una interfaz que permite personalizar la configuración de nuestras aplicaciones: Vistas, Interceptores, manejo de recursos estaticos, etc.
    ...
    @Override // Anotación que indica que estamos sobrescribiendo un método de la interfaz WebMvcConfigurer
    public void addInterceptors(InterceptorRegistry registry) { // InterceptorRegistry pertenece a WebMvc..., Método que permite registrar interceptores personalidados en nuestra aplicacion
